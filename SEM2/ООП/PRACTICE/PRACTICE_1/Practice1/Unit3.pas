...
begin
  ...
  for i := 1 to 7 do begin
      ...
      Image1.Canvas.Ellipse(15+dx-2, 260-(dy-2),15+dx+2, 260-(dy+2));
      Image1.Canvas.Pen.Width := 1;
      str(a[i], st);
      Image1.Canvas.TextOut(1, 260-dy, st);
      Image1.Canvas.MoveTo(15+dx, 260-dy);
  end;
